  ...
  return (
    <main data-testid="auth-page-shell" className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#030712] px-6 py-12 text-white">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Hero text */}
        <p className="inline-flex rounded-full border border-gold/25 bg-gold/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-goldLight">Login</p>
        <h1 className="animate-fade-up mt-4 text-4xl font-semibold tracking-tight">Welcome back, trader.</h1>
