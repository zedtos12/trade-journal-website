  ...
  return (
    <main data-testid="auth-page-shell" className="bg-grid-luxury relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,#172554_0%,#050816_42%,#030712_100%)] px-6 py-12 text-white">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <p className="text-sm uppercase tracking-[0.3em] text-gold">Create Account</p>
        <h1 className="animate-fade-up mt-3 text-4xl font-semibold tracking-tight">Start journaling your trades.</h1>
        <p className="mt-3 text-slate-400">Data trade kamu private dan terpisah per user.</p>
