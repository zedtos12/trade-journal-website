    ...
    <AppShell>
      ...
      <div className="mt-6 flex flex-col justify-between gap-4 md:flex-row md:items-start">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-semibold">{trade.pair}</h1>
        ...
        <div className="flex gap-3">
          <Link href={`/trades/${trade.id}/edit`} className="rounded-full bg-gold px-4 py-2 font-semibold text-slate-950">Edit</Link>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
          <h2 className="text-xl font-semibold">Trade metadata</h2>
      ...
      <section className="mt-6 rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        <h2 className="text-xl font-semibold">Psychology & Review</h2>
        <div className="mt-5 grid gap-3 md:grid-cols-2">
